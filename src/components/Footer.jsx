        ...
        <footer className="footer-wrapper">
            <div className="footer-container">
                <div className="footer-content">
                    ...
                    <div className="contact-info-wrapper opacity-0 animate-fade-in-up delay-100">
                        {/* Location */}
                        ...
                        <a href="mailto:hello@example.com" className="contact-item">
                            ...
                            <span className="contact-text">hello@example.com</span>
                        </a>
                    ...
                    <div className="social-icons-wrapper opacity-0 animate-fade-in-up delay-300">
                        {/* LinkedIn */}
